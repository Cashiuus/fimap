...
__author__="Cashiuus (formerly Iman Karim)"
__date__ ="aug-28-2021"
__version__ = "2.00 beta"
config = {}
...
pluginlist = "https://github.com/Cashiuus/fimap"
defupdateurl = "https://github.com/Cashiuus/fimap/tree/master/src/plugins"
...
def show_credits():
    print("## Credits:")
    print("## Developer: Iman Karim")
    print("#")
    print("## Project Home: https://github.com/Cashiuus/fimap")
    print("#")
...
if __name__ == "__main__":
    ...
    config["p_list"] = None
    config["p_verbose"] = 2
    config["p_useragent"] = "fimap_scanner/v%s github.com/Cashiuus/fimap" %__version__
    config["p_pages"] = 10
    config["p_query"] = None
    ...
    if (doUpdateDef):
        ...
        print("[*] Checking for updaes for additional language sets defined in 'generic.xml'...")
    ...
    if (doInstallPlugins):
        ...
        if result == None:
            print("[ERR] Failed to request plugins! Are you online?")
            sys.exit(1)
    ...
    if (doMergeXML):
        ...
        print("%d new vulnerabilities added from %d new domains" %(newVulns, newDomains))
        sys.exit(0)
    ...
    try:
        ...
        print("Send the following stacktrace to the bugtracker on https://github.com/Cashiuus/fimap")
